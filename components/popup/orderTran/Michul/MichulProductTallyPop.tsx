...
/** 상품별 집계현황 팝업 */
export const MichulProductTallyPop = () => {
  /** 금일내역 스토어 - State */
  const [openModal, modalType, closeModal] = useRetailStore((s) => [s.openModal, s.modalType, s.closeModal]);
      ...
      footer={
        <PopupFooter>
          <div className="btnArea">
            <button className="btn" title="거래내역">
              거래내역
            </button>
