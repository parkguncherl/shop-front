...
export const CustomChartLeftMargin = ({ type, axis = 'horizontal', title, xAxisData, yAxisData, legendData, series, width, containerStyle }: Props) => {
