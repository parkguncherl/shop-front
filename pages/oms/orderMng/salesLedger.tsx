/**
 * @file pages/oms/orderMng/salesLedger.tsx
 * @description  OMS > 판매원장
...
const PartnerMng = () => {
  ...
  const [columnDefs] = useState<ColDef[]>([
    ...
    { field: ' ', headerName: '구분', minWidth: 80, cellStyle: GridSetting.CellStyle.CENTER, suppressHeaderMenuButton: true },
  ...
  return (
    <div>
      ...
      {/*<span style={{ marginLeft: '10px', fontSize: '14px', color: '#666' }}>(참고: 헤더 판매거래 → 판매원장)</span>*/}
