!(function (S) {
  ...
  (S.fn.printThis = function (e) {
    ...
    var y = S('#' + t);
    C.debug || y.css({ position: 'absolute', width: '0px', height: '0px', left: '-600px', top: '-600px' }),
      ...
      setTimeout(function () {
        ...
        C.doctypeString &&
          ((e = y),
          (t = C.doctypeString),
          (i = (n = (n = e.get(0)).contentWindow || n.contentDocument || n).document || n.contentDocument || n).open(),
          i.write(t),
          i.close());
        var a,
          o = y.contents(),
          ...
          s = o.find('body'),
          c = S('base');
        (a = !0 === C.base && 0 < c.length ? c.attr('href') : 'string' == typeof C.base ? C.base : document.location.protocol + '//' + document.location.host),
        ...
        if (
          (m &&
            (-1 !== (m = !0 === m ? 'bh' : m).indexOf('b') && s.addClass(S('body')[0].className),
          ...
          C.canvas &&
            s.find('canvas').each(function () {
              ...
              this.getContext('2d').drawImage(t[0], 0, 0),
                S.isFunction(S.fn.removeAttr)
                  ? t.removeAttr('data-printthis')
        ...
        b(s, C.footer),
          ...
          setTimeout(function () {
            y.hasClass('MSIE')
              ? (window.frames.printIframe.focus(), r.append('<script>  window.print(); </script>'))
              : document.queryCommandSupported('print')
              ? y[0].contentWindow.document.execCommand('print', !1, null)
              : (y[0].contentWindow.focus(), y[0].contentWindow.print()),
              C.debug ||
                setTimeout(function () {
                  y.remove();
                }, 1e3),
